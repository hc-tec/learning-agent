...
def _coerce_langfuse_identifier(value: Any) -> str:
...
def resolve_langfuse_trace_id(observation: Any, trace_id: str | None = None) -> str:
    return (
        _coerce_langfuse_identifier(trace_id)
        or _coerce_langfuse_identifier(getattr(observation, "trace_id", ""))
...
def build_langfuse_observation_link(
    ...
    parent_observation_id = _coerce_langfuse_identifier(
        getattr(observation, "id", "")
    ) or _coerce_langfuse_identifier(getattr(observation, "observation_id", ""))
